...
module.exports.log = function(log){
    ...
    if(log.logname === 'request'){
        return console.log([log["@timestamp"], log.logname, method, log.url, query, statusCode, duration].join(", ")); // eslint-disable-line no-console
    }

    console.log([log["@timestamp"], log.logname, stringifySafe(log.err || log.data)].join(", ")); // eslint-disable-line no-console
};
